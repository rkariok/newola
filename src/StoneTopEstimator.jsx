...
export const SettingsSidebar = ({ settings, onChange }) => {
  ...
  // Debug logging
  console.log('Current settings in sidebar:', settings);
  console.log('Material buffer value:', settings.materialBuffer);
  console.log('Kerf width value:', settings.kerfWidth);
      ...
      <div className="space-y-6">
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-2">
            Kerf Width (Current: {settings.kerfWidth}")
          </label>
          <select
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-2">
            Material Buffer (Current: {settings.materialBuffer}%)
          </label>
          <select
            value={settings.materialBuffer}
